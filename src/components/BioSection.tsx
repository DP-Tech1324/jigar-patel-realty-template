...
import { Award, Users, Home, Star, ArrowRight, Phone, Mail, MapPin } from "lucide-react";
...
const BioSection = () => {
  ...
  const achievements = [
    ...
    },
    {
      ...
      description: "In GTA real estate"
    },
    {
      icon: Star,
      number: "5.0",
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="relative">
              <div className="aspect-[4/5] bg-gradient-to-br from-blue-100 via-slate-100 to-blue-200 rounded-3xl flex items-center justify-center shadow-2xl overflow-hidden">
                <div className="text-center p-8">
                  <div className="w-32 h-32 bg-gradient-to-br from-blue-600 to-blue-800 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                    <span className="text-white text-4xl font-bold">JP</span>
                  </div>
                  ...
                  <p className="text-xs text-slate-400 mt-2">Upload photo in admin panel</p>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-6 text-white text-center">
              <h4 className="font-bold text-lg mb-3">Professional Certifications</h4>
              <div className="space-y-2 text-sm">
                <div>• Licensed Real Estate Broker</div>
                <div>• RECO Certified Professional</div>
                <div>• Investment Property Specialist</div>
                <div>• Luxury Home Marketing Specialist</div>
              </div>
            </div>
          </div>
        </div>
